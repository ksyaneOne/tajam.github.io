...
$(document).ready(function(){$(".header-nav ul li a, .top").mPageScroll2id(),$(".header").css("min-height",$(window).height()),$(".header-carousel").owlCarousel({loop:!0,smartSpeed:700,responsiveClass:!0,dots:!0,responsive:{0:{items:1}}}),$(".people-carousel").owlCarousel({loop:!0,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],smartSpeed:700,responsiveClass:!0,dots:!0,startPosition:2,responsive:{0:{items:1}}}),$(".preloader").fadeOut(),$(".box").waypoint(function(s){"down"===s?$(this).removeClass("fadeOutDown").addClass("fadeInUp"):$(this).removeClass("fadeInUp").addClass("fadeOutDown")},{offset:"90%"}).waypoint(function(s){"down"===s?$(this).removeClass("fadeInUp").addClass("fadeOutDown"):$(this).removeClass("fadeOutDown").addClass("fadeInUp")},{offset:-50}),$(".box1").waypoint(function(s){"down"===s?$(this).removeClass("fadeOutRight").addClass("fadeInRight"):$(this).removeClass("fadeInRight").addClass("fadeOutRight")},{offset:"90%"}).waypoint(function(s){"down"===s?$(this).removeClass("fadeInRight").addClass("fadeOutRight"):$(this).removeClass("fadeOutRight").addClass("fadeInRight")},{offset:-50}),$(".box2").waypoint(function(s){"down"===s?$(this).removeClass("fadeOut").addClass("fadeIn"):$(this).removeClass("fadeIn").addClass("fadeOut")},{offset:"90%"}).waypoint(function(s){"down"===s?$(this).removeClass("fadeIn").addClass("fadeOut"):$(this).removeClass("fadeOut").addClass("fadeIn")},{offset:-50}),$(".header-nav-btn").click(function(){$(".header-nav-btn").toggleClass("toggle"),$(".header-nav").toggleClass("header-nav-toggle")})}),$(window).scroll(function(){$(document).scrollTop()>150?$(".top").addClass("show").show():$(".top").removeClass("show").hide()});